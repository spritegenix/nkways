        ...
        <div class="row  product-grid pb-3" style="">
            ...
            <div class="col-md-6">
                ...
                <div class="media_box p-2">
                    ...
                    <div class="form-group mt-2">
                        <div class="m-b-30">
                            <div class="row web_pageeefro tumbimage" id="thumb_upload_form">
                                <input type="file" id="web_page_file" name="tumbimages[]" accept="image/*" multiple class="image_preview">
                    ...
                    <div class="form-group mt-2">
                        <div class="input-box mt-0 <?= (!empty($po['video_link'])) ? 'active' : '' ?>">
                            <label class="input-label">Youtube/Video link</label>
                            <input type="text" class="input-1" name="video_link" value="<?= $po['video_link'] ?>" onfocus="setFocus(true)" onblur="setFocus(false)" />
                        </div>
                    </div>
                ...
                <div class="media_box p-2">
                    ...
                    <div class="form-group">
                        <div class="input-box <?= (!empty($po['post_name'])) ? 'active' : '' ?>">
                            ...
                            <select class="input-1" id="post_name" name="post_name" required onfocus="setFocus(true)" onblur="setFocus(false)" onchange="setChange()">
                                ...
                                <option value="project" <?php if ($po['post_name'] == 'project') {
                                                            echo "selected";
                                                        } ?>>Project</option>
                            </select>
                        </div>
                    ...
                    <div id="project_fileds" class="row <?php if ($po['post_name'] != 'project') {
                        ...
                        <div class="form-group col-md-6">
                            <div class="input-box mt-0 <?= (!empty($po['project_date'])) ? 'active' : '' ?>">
                                <label class="input-label">Select Date</label>
                                <input type="date" class="input-1" name="project_date" value="<?= $po['project_date'] ?>" onfocus="setFocus(true)" onblur="setFocus(false)" />
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        <textarea id="rich_editor" name="long_desc"> <?= $po['description'] ?></textarea>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    $('#featured_upload_form input').change(function() {
        ...
        if (this.files[0].size > 300000) {
            ...
            $('#error_msg').html('File size must be less than 300kb!')
        } else {
            $('#featured_upload_form p').text(this.files[0].name);
    ...
    $('#thumb_upload_form input').change(function() {
        ...
        if (this.files[0].size > 300000) {
            ...
            $('#error_msg_thmb').html('File size must be less than 300kb!')
        } else {
            $('#thumb_upload_form #p_text').text("");
